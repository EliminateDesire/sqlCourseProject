    ...
    <div class="container">
        <div class="select">
            ...
            <ul id="accordion" class="accordion">
                <li><div class="link"><a href="teaOpenCourse.jsp">开课</a></div></li>
                <li><div class="link"><a href="teaCourseQuery.jsp">我的课程</a></div></li>
                <li><div class="link"><a href="teaGradeSubmit.jsp">上传成绩</a></div></li>
                <li><div class="link"><a href="teaGradeQuery.jsp">查询成绩</a></div></li>
            </ul>
        </div>
